  ...
  return (
    <>
      ...
      <div className='OurTool mt-[80px]'>
        <div className='OurToolContainer flex items-center justify-center px-[30px]'>
          <div className="flex flex-col w-[600px]">
      ...
      <div className='OurToolContainer flex items-center justify-between px-[30px] gap-[30px]'>
      ...
      <div className='OurTool mt-[80px] bg-[#043873] text-white'>
        <div className='OurToolContainer flex items-center justify-center px-[30px]'>
          <div className="flex flex-col w-[600px]">
...
<h1 className="text-5xl font-bold ">Our Sponsors</h1>
  ...
  <div className='OurToolContainer flex items-center justify-around px-[30px] gap-[30px] bg-[#043873] p-6 text-white'>
